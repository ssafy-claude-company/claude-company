...
murmur  dd9ad94   ← HEAD — ★요금제 실비 재설계(무료300·스타터1,500/29,000·프로6,000/99,000 — 만사용 마진 28%/16%, env 조정 가능)+3카드 재디자인(타일 제거·스타터 인기 강조) · ★한국어 전면 재작성(번역투 제거: 원화 표기·턴/실측/$ 제거·자연 문장 — 결제 표면 전체) · ★카피 확정(실측 6크레딧/턴·프로=1,600턴 — 애매어 제거) · ★전용 요금제 페이지 /plans(07-18 밤, 사용자: '결제창이 결제하고 싶게'):
