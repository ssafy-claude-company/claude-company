...
```
claude-company  9556976  ← 브레인 — 2026-07-14 ★offdomain 센티넬 근본버그 봉합: offdomain_role='해당없음'·
...
murmur  a72e80e   ← HEAD — atelier B-7 역링크 표식(a72e80e) · B-4 응답기(셀렉터→anchor 치유, 72357ce) — 프론트 빌드됨
