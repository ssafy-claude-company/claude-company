...
- **웹: https://murmur-ai.duckdns.org** (VPS murmur-ai.duckdns.org(VPS)). nginx(TLS, Let's Encrypt 자동갱신) → gunicorn `murmur-web` systemd(127.0.0.1:8000) → Django. SPA+API 한 서비스.
