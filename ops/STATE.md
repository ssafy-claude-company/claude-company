...
murmur  0dbce0d   ← HEAD — ★모바일 감사 수리(단계 제목 소실·중복 스타일·플레이스홀더 잘림 — 라이브 실측 검증) · ★UX 전면 감사 일괄(전 화면 촬영 감사 — 핸들→아이디·LLM/러너→모델/서비스 공통·환경변수→API 키 금고·강도 한국어·해요체·keep-all) · ★실결제 안정층(웹훅 검증-재조회·자가치유 대사·원자 확정·결제내역/영수증·
