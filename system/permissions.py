...
_TOOL_REDIRECT = {
    ...
    "TaskList": "별도 작업관리 도구는 없습니다 — 현재 Task·상태는 채널 상태블록에서 봅니다. Task 생성·마감(create_task/complete_task)은 자리가 아니라 관문입니다: 팀의 누구든 호출할 수 있고, 옳은지는 관문이 증거로 판정합니다(자격이 모자라면 사유와 함께 거절).",
